...
![The Proctor workspace before any examinee has connected](../assets/images/general/proctoring-view.jpg)

The workspace lists each connected examinee as they sign in; until then it shows
the waiting state above.
